...
{
    /// <summary>
    /// Automatically centers and scales the camera to fit the simulation grid.
    /// Stage 8: Moved from Assets.Scripts.Visuals to Viable.Core.Unity.Visuals.
    /// </summary>
    public class CameraController : MonoBehaviour
    {
        [Tooltip("Reference to the SimulationGrid to center on")]
        public Controllers.SimulationGrid Grid;
        ...
        void LateUpdate()
        {
            ...
            if (cam.orthographic)
            {
                ...
                cam.orthographicSize = (maxDimension / 2f);
            }
        }
    }
}
